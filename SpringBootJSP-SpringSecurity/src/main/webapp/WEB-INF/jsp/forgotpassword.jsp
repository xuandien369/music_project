	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<c:url value="/resources/images/bg-01.jpg"/>');">
			...
			<div class="wrap-login100">
				<form action="<c:url value='/forgot_password'/>" class="login100-form validate-form" method="post" >
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter username">
						<input class="input100" type="email" name="email" placeholder="Enter your e-mail" required autofocus">
